...
TEST(configurers_utils, check_valid_ip)
{
    ...
    EXPECT_EQ(check_valid_ip("127.0.0.2", "127.0.0.0", "127.255.255.0"), IPValidationType::VALID);
    EXPECT_EQ(check_valid_ip("225.0.64.2", "224.0.0.0", "239.255.34.255"), IPValidationType::VALID);
    EXPECT_EQ(check_valid_ip("227.0.0.2", "227.0.0.0", "A.255.255.0"), IPValidationType::INVALID_FORMAT);
    EXPECT_EQ(check_valid_ip("127.0.0,2", "127.0.0.0", "127.255.255.0"), IPValidationType::INVALID_FORMAT);
    EXPECT_EQ(check_valid_ip("127.0.512.2", "127.0.0.0", "127.255.255.0"), IPValidationType::INVALID_NUMBERS);
    EXPECT_EQ(check_valid_ip("1024.0.0.2", "127.0.0.0", "127.255.255.0"), IPValidationType::INVALID_NUMBERS);
    EXPECT_EQ(check_valid_ip("127.0.0.2", "127.0.0.255", "127.255.255.0"), IPValidationType::OUT_OF_RANGE);
    EXPECT_EQ(check_valid_ip("224.0.0.2", "127.0.0.0", "127.255.255.0"), IPValidationType::OUT_OF_RANGE);
}
